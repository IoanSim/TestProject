(function () {
    ...
    function createRedirectController($scope, $http, editorService, contentResource, mediaResource, languageResource) {
        ...
        function openLinkPicker() {
            var linkPickerDialogOptions = {
                title: "Set link",
                view: "/App_Plugins/SeoToolkit/Redirects/Dialogs/linkPicker.html",
                size: "small",
    ...
    angular.module("umbraco").controller("SeoToolkit.Redirects.CreateController", createRedirectController);
})();